modifier_random_spell_04c = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_random_spell_04c:IsHidden()
	return true
end

function modifier_random_spell_04c:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_random_spell_04c:OnCreated( kv )
	if IsServer() then
		-- references
		self.damage = 999
...
function modifier_random_spell_04c:OnDestroy( kv )
	if IsServer() then
		-- Damage enemies
		local damageTable = {
			-- victim = target,
...
--------------------------------------------------------------------------------
-- Graphics & Animations
function modifier_random_spell_04c:PlayEffects1()
	-- Get Resources
...
function modifier_random_spell_04c:PlayEffects2()
	-- Get Resources
