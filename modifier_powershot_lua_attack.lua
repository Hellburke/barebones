modifier_powershot_lua_attack = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_powershot_lua_attack:IsHidden()
	return true
end
function modifier_powershot_lua_attack:IsPurgable()
	return false
end

--------------------------------------------------------------------------------
-- Initializations
function modifier_powershot_lua_attack:OnCreated( kv )
	-- references
...
--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_powershot_lua_attack:DeclareFunctions()
	local funcs = {
...
function modifier_powershot_lua_attack:GetModifierDamageOutgoing_Percentage( params )
	if IsServer() then
		return self.attack_factor
	end
end
function modifier_powershot_lua_attack:GetModifierPreAttack_BonusDamage( params )
	-- get data
	if IsServer() then
